function [ NN_array ] = extract_NN(dir_name, file_name )
...
%(2)The NN relevant part is extracted from this:
start_chopped = extract_start( file_cell_array, '<baryon_num>9</baryon_num>');
...
NN_array = string_to_num_array( relevant_string_array );
